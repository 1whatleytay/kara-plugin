...
public class KaraTypenameOptionalImpl extends ASTWrapperPsiElement implements KaraTypenameOptional {

  public KaraTypenameOptionalImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KaraVisitor visitor) {
    visitor.visitTypenameOptional(this);
  }

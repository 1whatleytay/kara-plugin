...
public class KaraTypenamePrimitiveImpl extends ASTWrapperPsiElement implements KaraTypenamePrimitive {

  public KaraTypenamePrimitiveImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KaraVisitor visitor) {
    visitor.visitTypenamePrimitive(this);
  }

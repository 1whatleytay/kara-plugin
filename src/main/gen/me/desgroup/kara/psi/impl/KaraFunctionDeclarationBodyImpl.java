...
public class KaraFunctionDeclarationBodyImpl extends ASTWrapperPsiElement implements KaraFunctionDeclarationBody {

  public KaraFunctionDeclarationBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KaraVisitor visitor) {
    visitor.visitFunctionDeclarationBody(this);
  }

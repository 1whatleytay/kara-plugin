...
public class KaraBodyAssignOpImpl extends ASTWrapperPsiElement implements KaraBodyAssignOp {

  public KaraBodyAssignOpImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KaraVisitor visitor) {
    visitor.visitBodyAssignOp(this);
  }

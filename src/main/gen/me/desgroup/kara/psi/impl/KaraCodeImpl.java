...
public class KaraCodeImpl extends ASTWrapperPsiElement implements KaraCode {

  public KaraCodeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public KaraBody getBody() {
    return findChildByClass(KaraBody.class);
  }

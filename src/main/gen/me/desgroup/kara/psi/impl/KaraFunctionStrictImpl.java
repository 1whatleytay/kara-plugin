...
public class KaraFunctionStrictImpl extends ASTWrapperPsiElement implements KaraFunctionStrict {

  public KaraFunctionStrictImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KaraVisitor visitor) {
    visitor.visitFunctionStrict(this);
  }

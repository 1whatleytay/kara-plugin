...
public class KaraTypenameNamedImpl extends ASTWrapperPsiElement implements KaraTypenameNamed {

  public KaraTypenameNamedImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KaraVisitor visitor) {
    visitor.visitTypenameNamed(this);
  }

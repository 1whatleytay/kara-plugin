...
public class KaraVariableLooseImpl extends ASTWrapperPsiElement implements KaraVariableLoose {

  public KaraVariableLooseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KaraVisitor visitor) {
    visitor.visitVariableLoose(this);
  }

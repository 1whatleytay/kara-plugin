...
public class KaraFunctionParametersImpl extends ASTWrapperPsiElement implements KaraFunctionParameters {

  public KaraFunctionParametersImpl(@NotNull ASTNode node) {
    super(node);
  }

...
public class KaraTypenameReferenceImpl extends ASTWrapperPsiElement implements KaraTypenameReference {

  public KaraTypenameReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KaraVisitor visitor) {
    visitor.visitTypenameReference(this);
  }

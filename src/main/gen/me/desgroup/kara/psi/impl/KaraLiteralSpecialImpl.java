...
public class KaraLiteralSpecialImpl extends ASTWrapperPsiElement implements KaraLiteralSpecial {

  public KaraLiteralSpecialImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KaraVisitor visitor) {
    visitor.visitLiteralSpecial(this);
  }

...
public class KaraModifierIndexImpl extends ASTWrapperPsiElement implements KaraModifierIndex {

  public KaraModifierIndexImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KaraVisitor visitor) {
    visitor.visitModifierIndex(this);
  }

...
public class KaraTypenameArrayImpl extends ASTWrapperPsiElement implements KaraTypenameArray {

  public KaraTypenameArrayImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KaraVisitor visitor) {
    visitor.visitTypenameArray(this);
  }
  ...
  @Override
  @Nullable
  public KaraTypenameArraySpec getTypenameArraySpec() {
    return findChildByClass(KaraTypenameArraySpec.class);
  }

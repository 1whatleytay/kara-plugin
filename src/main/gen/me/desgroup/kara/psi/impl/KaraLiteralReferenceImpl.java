...
public class KaraLiteralReferenceImpl extends ASTWrapperPsiElement implements KaraLiteralReference {

  public KaraLiteralReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KaraVisitor visitor) {
    visitor.visitLiteralReference(this);
  }

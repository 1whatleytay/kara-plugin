...
public class KaraFunctionLooseImpl extends ASTWrapperPsiElement implements KaraFunctionLoose {

  public KaraFunctionLooseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KaraVisitor visitor) {
    visitor.visitFunctionLoose(this);
  }

...
public class KaraTypeAliasBodyImpl extends ASTWrapperPsiElement implements KaraTypeAliasBody {

  public KaraTypeAliasBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KaraVisitor visitor) {
    visitor.visitTypeAliasBody(this);
  }

...
public class KaraModifierCallPartImpl extends ASTWrapperPsiElement implements KaraModifierCallPart {

  public KaraModifierCallPartImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KaraVisitor visitor) {
    visitor.visitModifierCallPart(this);
  }

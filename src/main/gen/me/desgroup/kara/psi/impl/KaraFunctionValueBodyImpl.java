...
public class KaraFunctionValueBodyImpl extends ASTWrapperPsiElement implements KaraFunctionValueBody {

  public KaraFunctionValueBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KaraVisitor visitor) {
    visitor.visitFunctionValueBody(this);
  }
